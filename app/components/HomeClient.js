      ...
      <section className="hero">
        ...
        <div className="container hero-centered">
          ...
          <p className="hero-sub">
            Glow Social keeps your profiles active with posts written in your voice, designed for your business, approved by you, and published where customers check.
          </p>
          <p className="hero-desc">
            No content calendar. No blank screen. No remembering to post after the workday is already over.
          </p>
          <form
