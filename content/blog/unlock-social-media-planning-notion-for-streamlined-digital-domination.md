...
|----------|------|---------|
| Post Title | Title | Brief description of the post |
| Platform | Multi-select | Facebook, Instagram, LinkedIn, GBP |
| Content Type | Select | Tip, Review, BTS, Promo, Community |
| Status | Select | Idea, Drafting, Ready, Scheduled, Published |
| Scheduled Date | Date | When the post will go live |
| Caption | Text | The post caption text |
| Image | Files & media | Attach the graphic or photo |
| Notes | Text | Internal notes, hashtags, links |
