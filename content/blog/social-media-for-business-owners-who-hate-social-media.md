...
faqs:
  - q: "Do I need social media if I hate social media?"
    a: "Most local businesses need a basic active presence because customers check social profiles, Google Business Profile, reviews, and photos before calling. You do not need to become a content creator."
  - q: "What is the easiest social media strategy for a business owner who hates posting?"
    a: "Keep complete profiles, post enough current proof that the business looks active, use reviews and photos you already have, and automate the repeatable posting work."
  - q: "Can I keep my business active online without posting myself?"
...
This is why [a Facebook page can make your business look closed](/blog/is-your-facebook-page-making-your-business-look-closed). The page does not need to be brilliant. It needs to look alive.
...
1. Batch it yourself once a month.
2. Delegate it to a person.
3. Automate the repeatable baseline.
