...
date: "2025-01-10"
faqs:
  - q: "What is the OBA framework for social media?"
    a: "The OBA framework stands for Observe, Build, Automate. It's a three-step system for creating a sustainable social media presence: first observe what works in your industry, then build a content system around those insights, then automate the execution so it runs without your daily involvement."
  - q: "How long does it take to implement the OBA framework?"
    a: "The full OBA framework takes about 2 weeks to implement: 1 week for observation, 1-2 days for building your system, and 5 minutes if you use a done-for-you service like Glow Social for the automation step. After that, your social media runs consistently with minimal input."
  - q: "Can you automate social media without it sounding robotic?"
    a: "Yes, if you follow the right order. The OBA framework works because you observe your audience and build a brand-specific system before automating. Services like Glow Social read your website to learn your voice and create content that sounds like your business, not a template."
---
...
1. **Expertise and tips** — Educational content that demonstrates your knowledge. How-to advice, common questions answered, industry insights.
2. **Social proof** — Customer reviews, testimonials, before-and-after photos, case studies.
3. **Behind the scenes** — Your team at work, your process, your workspace. This humanizes your brand.
4. **Promotions and offers** — Special deals, seasonal offers, new services. Keep this to no more than 20% of your content.
5. **Community and local** — Local events, partnerships with other businesses, neighborhood shout-outs.
