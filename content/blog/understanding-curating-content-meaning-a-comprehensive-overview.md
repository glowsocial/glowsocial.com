...
date: "2024-12-12"
faqs:
  - q: "What does content curation mean in social media?"
    a: "Content curation means finding and sharing relevant content created by others — industry articles, local news, expert insights — rather than creating everything from scratch. You add your own perspective or commentary when sharing, which positions your business as knowledgeable and connected."
  - q: "What is a good ratio of curated to original content?"
    a: "A balanced social media strategy follows approximately 60% original content (your work, services, team), 20% curated content (industry articles, local news, expert insights), and 20% engagement content (questions, polls, conversations). Adjust based on what your audience responds to."
  - q: "Is curating content the same as copying?"
    a: "No. Curating means sharing others' content with proper attribution while adding your own perspective. Copying is republishing without credit. When you curate, always tag the original source, add your own commentary, and explain why it matters to your audience."
---
