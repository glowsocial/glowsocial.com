...
faqs:
  ...
  - q: "How do I create a social media content calendar for my small business?"
    a: "Start with a simple spreadsheet with columns for date, platform, content category, caption, image status, and published status. Choose 4-5 content categories, assign them to specific days, and plan 2-4 weeks in advance. Or skip the calendar entirely and use a done-for-you service that handles the planning and execution."
---
...
1. **Ideas** column — content concepts waiting to be developed
2. **In Progress** column — posts being written and designed
3. **Ready to Schedule** column — finished posts awaiting scheduling
4. **Published** column — completed posts with engagement notes
...
For a complete breakdown of content categories, see our [content strategy guide](/blog/why-is-content-strategy-important-for-social-media-success).
