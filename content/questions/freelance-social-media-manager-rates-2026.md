...
relatedResources:
  ...
  - title: "Social Media Manager Prices"
    ...
    description: "Quick answer for social media manager prices and what each price tier includes."
  - title: "Should I Hire a Freelancer?"
    href: "/resources/questions/should-i-hire-a-freelancer-for-social-media"
    description: "Decision guide for hiring a freelancer versus using software or done-for-you posting."
...
## Real-World Example
A solo salon owner might pay $400/month for a freelancer to create 12 posts for Instagram and Facebook. That can be fair if the package includes captions, graphics, scheduling, and one revision round. The same salon should expect a much higher price if it wants weekly Reels, comment replies, influencer outreach, and monthly performance reporting.
